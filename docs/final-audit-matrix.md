...
| :--- | :--- | :--- | :--- |
| **Income Tax (`/tax`)** | Finance Act, 2026 & Income-tax Act, 2025 | **VERIFIED** | Slabs (Nil up to ₹4L, 5% to ₹8L, 10% to ₹12L, 15% to ₹16L, 20% to ₹20L, 25% to ₹24L, 30% above). ₹75,000 standard deduction strictly on salary/pension. Section 157 rebate up to ₹12L ordinary income with marginal relief tapering to ₹12,70,588. |
