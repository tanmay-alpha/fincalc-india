      ...
      <div className="mx-auto h-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-full items-center justify-between">
          <Link href="/" className="flex items-center gap-1">
            <span className="font-bold text-slate-900 dark:text-white">FinCalc</span>
            <span className="font-bold text-blue-600">{' '}India</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            {!session ? (
              <button
                ...
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-sm font-semibold px-4 py-2 rounded-xl shadow-sm transition-all duration-150 whitespace-nowrap"
              >
