        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {popularTools.map((calc) => (
            <Link
              key={calc.id}
              href={calc.route}
              className="group min-h-[96px] sm:min-h-[104px] p-4 rounded-xl border border-border/70 bg-card hover:border-primary/30 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {CATEGORIES.map((cat) => (
            <Link
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border border-border/70 bg-card hover:bg-muted/60 hover:border-primary/30 text-xs font-medium text-foreground hover:text-primary transition-all shadow-2xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
